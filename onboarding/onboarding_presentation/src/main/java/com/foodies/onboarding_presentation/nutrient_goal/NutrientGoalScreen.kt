package com.foodies.onboarding_presentation.nutrient_goal
...
import com.foodies.onboarding_presentation.components.UnitTextField
...
fun NutrientGoalScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = com.foodies.core.R.string.what_are_your_nutrient_goals),
            ...
            UnitTextField(
                ...
                unit = stringResource(id = com.foodies.core.R.string.percent_carbs)
            )
            Spacer(modifier = Modifier.height(spacing.spaceMedium))
            UnitTextField(
                ...
                unit = stringResource(id = com.foodies.core.R.string.percent_proteins)
            )
            Spacer(modifier = Modifier.height(spacing.spaceMedium))
            UnitTextField(
                ...
                unit = stringResource(id = com.foodies.core.R.string.percent_fats)
            )
        }
        ActionButton(
