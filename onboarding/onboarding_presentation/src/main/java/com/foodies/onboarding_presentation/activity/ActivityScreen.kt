package com.foodies.onboarding_presentation.activity
...
fun ActivityScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = com.foodies.core.R.string.whats_your_activity_level),
                style = MaterialTheme.typography.h3
            )
            Spacer(modifier = Modifier.height(spacing.spaceMedium))
            Row {
                SelectableButton(
                    text = stringResource(id = com.foodies.core.R.string.low),
                ...
                SelectableButton(
                    text = stringResource(id = com.foodies.core.R.string.medium),
                ...
                Spacer(modifier = Modifier.width(spacing.spaceMedium))
                SelectableButton(
                    text = stringResource(id = com.foodies.core.R.string.high),
