package com.foodies.onboarding_presentation.goal
...
fun GoalScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = com.foodies.core.R.string.lose_keep_or_gain_weight),
                style = MaterialTheme.typography.h3
            )
            Spacer(modifier = Modifier.height(spacing.spaceMedium))
            Row {
                SelectableButton(
                    text = stringResource(id = com.foodies.core.R.string.lose),
                ...
                SelectableButton(
                    text = stringResource(id = com.foodies.core.R.string.keep),
                ...
                Spacer(modifier = Modifier.width(spacing.spaceMedium))
                SelectableButton(
                    text = stringResource(id = com.foodies.core.R.string.gain),
